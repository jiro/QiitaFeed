...
#define COCOAPODS_VERSION_MAJOR_Moya_Core 0
#define COCOAPODS_VERSION_MINOR_Moya_Core 6
#define COCOAPODS_VERSION_PATCH_Moya_Core 1

// Moya/Reactive
#define COCOAPODS_POD_AVAILABLE_Moya_Reactive
#define COCOAPODS_VERSION_MAJOR_Moya_Reactive 0
#define COCOAPODS_VERSION_MINOR_Moya_Reactive 6
#define COCOAPODS_VERSION_PATCH_Moya_Reactive 1
